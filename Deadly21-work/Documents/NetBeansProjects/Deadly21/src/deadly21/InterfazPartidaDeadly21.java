...
public class InterfazPartidaDeadly21 extends javax.swing.JFrame {
    ...
    public void Partida(int i,int decision){
       ...
       System.out.println("ero");
        ...
        else if(Rival.sePaso() || Jugador.esBlackjack() || Jugador.sumMano()>Rival.sumMano()){
            Rondas++;
            Jugador.rondasGanadas++;
            contador = 0;
             System.out.println("gANO JUGADOR");
        }
        else if(Jugador.sumMano()==Rival.sumMano()){
            Rondas++;
            contador = 0;
        ...
        if(Jugador.rondasGanadas == 3){
            System.out.println("ganaste");
            continuar(1);
            
        }
        else if(Rival.rondasGanadas == 3){
            System.out.println("perdiste");
            continuar(0);
        }
        else if(Rondas == 5){
            if(Jugador.rondasGanadas >= Rival.rondasGanadas){
                System.out.println("ganaste");
                continuar(1);
            }
            else{
